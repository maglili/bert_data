...
for i in range(len(df)):
    ...
    elif (Symbol_A in symbol_and_its_alias) and (
        Synonyms_A not in symbol_and_its_alias[Symbol_A]
    ):
    ...
    elif (Symbol_B in symbol_and_its_alias) and (
        Synonyms_B not in symbol_and_its_alias[Symbol_B]
    ):
